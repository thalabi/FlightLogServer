...
public class OldComponentRowMapper implements RowMapper<OldComponent> {
	...
	public static final String WORK_PERFORMED = "work_performed";
	...
	public OldComponent mapRow(ResultSet rs, int rowNum) throws SQLException {
		return OldComponent.builder().partName(rs.getString(PART_NAME)).activityPerformed(rs.getString(WORK_PERFORMED))
